...
\newcommand{\basicPos}[1]{\overline{\mathtt{pos}}(#1)}
\newcommand{\varPos}[1]{\mathtt{varPos}(#1)}
\newcommand{\parPos}[2]{#1\,||\,#2} %Pararell positions

\newcommand{\narrow}{\mathbin{\rightsquigarrow}}
\newcommand{\trs}{\mathcal{R}}
\newcommand{\trsNF}[1]{#1\mathord{\downarrow}}

\newcommand{\contr}{\rightarrow}
\newcommand{\contrR}{\leftarrow}
\newcommand{\tc}{\twoheadrightarrow^{+}}
\newcommand{\stc}{\twoheadrightarrow}
\newcommand{\stcR}{\twoheadleftarrow}

\newcommand{\rewriteOnGoals}{\rightarrowtail}

\newcommand{\fresh}{\#}

\newcommand{\constructors}{\mathcal{C}}
\newcommand{\defFunctions}{\mathcal{D}}
...
% Examples Function and specifications
\newcommand{\appFunc}[2]{\mathtt{app}\left(#1,#2\right)}
\newcommand{\nilList}{\mathtt{nil}}

...
Holldobler [cite] showed that basic conditional narrowing is complete for complete 1-CTRSs. However, the following example shows that this result is indeed not valid.
